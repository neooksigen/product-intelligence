...
engine = create_engine(DATABASESQLALCHEMY_URL, poolclass=NullPool,  pool_pre_ping=True, pool_recycle=300) #15 mar 2026 pool_pre_ping to ensure test the connection before using it, pool_recycle to refresh connection every 2 minutes
